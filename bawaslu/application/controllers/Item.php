...
class item extends CI_Controller {
    ...
    function get_ajax() {
        ...
        foreach ($list as $item) {
            ...
            $row = array();
            $row[] = $no.".";
            $row[] = $item->kode_barang.'<br><a href="'.site_url('item/kode_barang_qrcode/'.$item->item_id).'" ';
            $row[] = $item->name;
            ...
            $row[] = '<a href="'.site_url('item/edit/'.$item->item_id).'" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                    <a href="'.site_url('item/del/'.$item->item_id).'" id="btn-hapus"  class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus</a>';
            $data[] = $row;
        }
        $output = array(
                    "draw" => @$_POST['draw'],
    ...
    {         
        ...
        if(!empty($tmp)) {
            $this->session->set_flashdata('danger', "Data  $tmp  Hampir Habis ");
        }
