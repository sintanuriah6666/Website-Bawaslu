...
class item_m extends CI_Model {
      // start datatables
      var $column_order = array(null, 'kode_barang', 'p_item.name', 'category_name', 'unit_name', 'price', 'image', 'stock'); //set column field database for datatable orderable
      var $column_search = array('kode_barang', 'p_item.name', 'price'); //set column field database for datatable searchable
