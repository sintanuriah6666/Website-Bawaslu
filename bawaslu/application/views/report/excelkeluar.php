...
<p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:center;line-height:115%;'><strong><span style='font-family:"Arial",sans-serif;'><?=   isset($post3['date1']) ? $post3['date2'] : '' ?> - <?=isset($post3['date1']) ? $post3['date2'] : '' ?></span></strong></p>
