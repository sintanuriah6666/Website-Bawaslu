...
<p style='margin:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:center;line-height:115%;'><strong><span style='font-family:"Arial",sans-serif;'><?=indo_date($post7['date1'])?> - <?=indo_date($post7['date2'])?></span></strong></p><br></br>
</style>
<br></br>
   <br></br>
    <table> 
